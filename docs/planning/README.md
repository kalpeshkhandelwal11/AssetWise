...
| [MODULES_INDEX.md](MODULES_INDEX.md) | Module map, parallel dev timeline, Laragon setup, cross-module contracts |
| [modules/](modules/) | Per-module specs (M00–M15) for Developer 1 / Developer 2 |

## Module files

- M00 Foundation → M07 Shared UI (Dev 1)
- M08 Approval Workflow → M15 PWA (Dev 2)
