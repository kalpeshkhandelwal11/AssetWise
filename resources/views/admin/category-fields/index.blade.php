                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.categories.fields.destroy', [$category, $field]) }}" onsubmit="return confirm('Delete this field? Existing saved values remain but become read-only.')">
                                        @csrf @method('DELETE')
